...
_SYSTEM = (
    ...
    "atskiros eilutės, ne viena \"Daržovės\"). "
    "Jeigu kvito eilutėje nurodytas KIEKIS didesnis nei 1 (pvz. \"2x "
    "Burger\", \"Kava 3vnt\", \"Duona x4\") — TOKIĄ eilutę PADALINK į tiek "
    "ATSKIRŲ prekių, koks kiekis nurodytas, kiekvienai priskiriant tą patį "
    "pavadinimą (be \"2x\" ar kiekio žymos jame) ir po lygiai iš eilutės "
    "bendros sumos (pvz. \"2x Burger 12.00\" → dvi atskiros \"Burger\" "
    "prekės po 6.00). Tai svarbu: šias prekes vėliau žmonės skirstosi "
    "tarpusavyje po vieną vienetą, todėl kiekvienas vienetas turi būti "
    "savo atskira eilute, o ne viena eilute su bendru kiekiu. "
    "PRIEŠ atsakydamas, perskaityk kvitą nuo viršaus iki apačios ir "
    "suskaičiuok, kiek eilučių jame atspausdinta — tiek atspausdintų "
    "eilučių turi būti atpažinta (plius papildomos eilutės ten, kur "
    "eilutė buvo padalinta dėl kiekio > 1, kaip aprašyta aukščiau), nė "
    "vienos nepraleisdamas. Po to patikrink: ar visų grąžintų eilučių "
