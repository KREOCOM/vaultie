...
class _DashboardPreviewState extends State<DashboardPreview>
  ...
  // 2026-08-16: PREVIEW-ONLY — "true frosted glass" (variant 01 of a set
  // explored in HTML first). Unlike the gradient-overlay capsule tried
  // earlier (reverted — read as a mismatched block with visible edges),
  // this uses a REAL BackdropFilter blur: it blurs/lightens the actual
  // hero gradient behind it rather than painting new colours on top, so it
  // structurally can't clash with what's underneath. ClipRRect is required
  // — BackdropFilter blurs its whole layer otherwise, ignoring the shape.
  Widget _balanceGlassCard(String balStr, double? delta, double? deltaPct) {
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Column(
              ...
              children: [
                if (designPreviewPalette)
                  _balanceGlassCard(balStr, delta, deltaPct)
                else ...[
                  Builder(builder: (_) {
