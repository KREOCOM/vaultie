        ...
        LegalSection(
          ...
          isLt
              ? 'Susikuriant paskyrą renkame tavo el. pašto adresą (per Firebase '
                  ...
                  'lokaliai tavo įrenginyje, užšifruoti, o raktas laikomas '
                  'paties telefono saugioje raktinėje. Kai perki „Vaultie Pro", '
                  'mūsų teikėjas „RevenueCat" apdoroja „App Store" pirkimą, kad '
                  'atrakintų prieigą.'
              : 'When you create an account we collect your email address (via '
                  ...
                  'locally on your device only, encrypted, with the key held in '
                  'the phone\'s own secure keychain. When you buy Vaultie Pro, '
                  'our provider RevenueCat processes your App Store purchase to '
